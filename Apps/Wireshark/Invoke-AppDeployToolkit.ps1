...
$adtSession = @{
    ...
    AppProcessesToClose = @('wireshark')  # Example: @('excel', @{ Name = 'winword'; Description = 'Microsoft Word' })
...
function Install-ADTDeployment
{
    ...
    Uninstall-ADTApplication -Name "wireshark" -ApplicationType 'MSI'
    ...
    #ARP 
     Set-ADTRegistryKey -Key "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\{1A3B87B4-D70D-4193-8231-291B0FC6A87A}" -Name "NoModify" -Value "1" -Type DWORD
     Set-ADTRegistryKey -Key "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\{1A3B87B4-D70D-4193-8231-291B0FC6A87A}" -Name "NoRemove" -Value "1" -Type DWORD
...
function Uninstall-ADTDeployment
{
    ...
    Show-ADTInstallationWelcome -CloseProcesses @{Name ="wireshark"} -Silent
