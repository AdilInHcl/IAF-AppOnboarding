...
$adtSession = @{
    ...
    AppProcessesToClose = @('MySQLWorkbench')  # Example: @('excel', @{ Name = 'winword'; Description = 'Microsoft Word' })
...
function Install-ADTDeployment
{
    ...
    Uninstall-ADTApplication -Name "MySQL Workbench 8.0 CE" -ApplicationType 'MSI'    
    ...
    #ARP 
     Set-ADTRegistryKey -Key "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\{4CB88837-0104-4BE9-9763-6084941B0366}" -Name "NoModify" -Value "1" -Type DWORD
     Set-ADTRegistryKey -Key "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\{4CB88837-0104-4BE9-9763-6084941B0366}" -Name "NoRemove" -Value "1" -Type DWORD
...
function Uninstall-ADTDeployment
{
    ...
    Show-ADTInstallationWelcome -CloseProcesses @{Name ="MySQLWorkbench"} -Silent
